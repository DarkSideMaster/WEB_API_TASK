...
## WEB API hierarchical tree

This WEB API  can help you create a hierarchical tree structure to organize your assets in your enterprise.  In response you will receive a JSON of the following structure:
